...
if (isset($_GET["id"])) {
    ...
    $sql_select = "SELECT * FROM equipamento WHERE id_equip = ? AND categoria = 'Cabeça De Impressão'";
...
<head>
    ...
    <title>Cabeça De Impressão</title>
</head>
<body>

    <h2 style="text-align: center;">Voltar o Cabeça De Impressão para o estoque</h2>
