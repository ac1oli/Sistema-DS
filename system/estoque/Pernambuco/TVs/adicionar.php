...
<head>
    ...
    <title>Adicionar TV</title>
</head>
<body class="adicionar">

    <h2 style="text-align: center;">Adiconar TV</h2>
    ...
    <form action="salvar.php" method="POST">
        ...
        <input type="text" name="polegadas" id="polegadas" placeholder="Polegadas" >
        ...
        <!-- Importante: categoria 'tvs' -->
        <input type="hidden" name="categoria" value="tvs">
