...
<body>
    ...
    <?php
        ...
        if(!empty($_GET['pesquisa'])){
            ...
            $pesq = $_GET['pesquisa'];
            $sql = "SELECT * FROM equipamento WHERE categoria = 'amplificador' AND status = 'ativo' AND local = 'PE' AND
            (marca LIKE '%$pesq%' or modelo LIKE'%$pesq%' or serial LIKE '%$pesq%' or data_entrada LIKE'%$pesq%')";

            $sql_count = "SELECT COUNT(*) AS total_amplificador FROM equipamento WHERE categoria = 'amplificador' AND status = 'ativo' AND local = 'PE' AND
            ...
            $sql = "SELECT * FROM equipamento WHERE categoria = 'amplificador' AND status = 'ativo' AND local = 'PE'";
