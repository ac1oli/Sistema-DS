...
<div id="navCont">
    ...
    <div class="card"> 
        <a href="Amplificador/index.php"> 
            <h3>Amplificador</h3>
            <?php     
                $sql_count = "SELECT COUNT(*) AS total_amplificador FROM equipamento WHERE categoria = 'amplificador' AND status = 'ativo'";
    ...
    <div class="card"> 
        <a href="Bateria/index.php"> 
            <h3>Bateria</h3>
            <?php     
                $sql_count = "SELECT COUNT(*) AS total_bateria FROM equipamento WHERE categoria = 'bateria' AND status = 'ativo'";
                $result_count = mysqli_query($conexao, $sql_count);
                if ($result_count) {
                    $row_count = mysqli_fetch_assoc($result_count);
    ...
    <div class="card"> 
        <a href="Celular/index.php"> 
            <h3>Celular</h3>
            <?php     
                $sql_count = "SELECT COUNT(*) AS total_celular FROM equipamento WHERE categoria = 'celular' AND status = 'ativo' ";
                $result_count = mysqli_query($conexao, $sql_count);
                if ($result_count) {
                    $row_count = mysqli_fetch_assoc($result_count);
    ...
    <div class="card"> 
        <a href="ChipCelular/index.php"> 
            <h3>Chips Celular</h3>
            <?php     
                $sql_count = "SELECT COUNT(*) AS total_chip FROM equipamento WHERE categoria = 'chip' AND status = 'ativo' ";
                $result_count = mysqli_query($conexao, $sql_count);
                if ($result_count) {
                    $row_count = mysqli_fetch_assoc($result_count);
    ...
    <div class="card"> 
        <a href="ColetorBluetooth/index.php"> 
            ...
            <?php     
                $sql_count = "SELECT COUNT(*) AS total_coletorB FROM equipamento WHERE categoria = 'Coletor Bluetooth' AND status = 'ativo'";
                $result_count = mysqli_query($conexao, $sql_count);
                if ($result_count) {
                    $row_count = mysqli_fetch_assoc($result_count);
    ...
    <div class="card"> 
        <a href="ColetorTouch/index.php"> 
            <h3>Coletor Touch</h3>
            <?php     
                $sql_count = "SELECT COUNT(*) AS total_coletorT FROM equipamento WHERE categoria = 'Coletor Touch' AND status = 'ativo'";
                $result_count = mysqli_query($conexao, $sql_count);
                if ($result_count) {
                    $row_count = mysqli_fetch_assoc($result_count);
    ...
    <div class="card"> 
        <a href="Etiquetadora/index.php">
            <h3> Etiquetadora</h3>
            <?php 
                $sql_count = "SELECT COUNT(*) AS total_etiquetadora FROM equipamento WHERE categoria = 'etiquetadora' AND status = 'ativo'";
                $result_count = mysqli_query($conexao, $sql_count);
                if ($result_count) {
                    $row_count = mysqli_fetch_assoc($result_count);
    ...
    <div class="card"> 
        <a href="Fontes/index.php"> 
            <h3>Fontes</h3>
            <?php     
                $sql_count = "SELECT COUNT(*) AS total_fontes FROM equipamento WHERE categoria  LIKE '%Fonte%' AND status = 'ativo' ";
                $result_count = mysqli_query($conexao, $sql_count);
                if ($result_count) {
                    $row_count = mysqli_fetch_assoc($result_count);
    ...
    <div class="card"> 
        <a href="Gabinete/index.php"> 
            <h3>Gabinete</h3>
            <?php     
                $sql_count = "SELECT COUNT(*) AS total_desktop FROM equipamento WHERE categoria = 'desktop' AND status = 'ativo' ";
                $result_count = mysqli_query($conexao, $sql_count);
                if ($result_count) {
                    $row_count = mysqli_fetch_assoc($result_count);
    ...
    <div class="card"> 
        <a href="HD/index.php"> 
            <h3>HD</h3>
            <?php     
                $sql_count = "SELECT COUNT(*) AS total_hd FROM equipamento WHERE categoria = 'hd' AND status = 'ativo'";
                $result_count = mysqli_query($conexao, $sql_count);
                if ($result_count) {
                    $row_count = mysqli_fetch_assoc($result_count);
    ...
    <div class="card"> 
        <a href="Impressora/index.php"> 
            <h3> Impressora </h3>
            <?php 
                $sql_count = "SELECT COUNT(*) AS total_impressora FROM equipamento WHERE categoria = 'impressora' AND status = 'ativo'";
                $result_count = mysqli_query($conexao, $sql_count);
                if ($result_count) {
                    $row_count = mysqli_fetch_assoc($result_count);
    ...
    <div class="card"> 
        <a href="ImpressoraTermica/index.php"> 
            <h3> Impre. Termica</h3>
            <?php 
                $sql_count = "SELECT COUNT(*) AS total_impressoraT FROM equipamento WHERE categoria = 'Impressora Térmica' AND status = 'ativo'";
                $result_count = mysqli_query($conexao, $sql_count);
                if ($result_count) {
                    $row_count = mysqli_fetch_assoc($result_count);
    ...
    <div class="card"> 
        <a href="Leitor_BARCOD/index.php"> 
            <h3> Leitor BARCOD </h3>
            <?php 
                $sql_count = "SELECT COUNT(*) AS total_leitor FROM equipamento WHERE categoria = 'leitor de barra' AND status = 'ativo'";
                $result_count = mysqli_query($conexao, $sql_count);
                if ($result_count) {
                    $row_count = mysqli_fetch_assoc($result_count);
    ...
    <div class="card"> 
        <a href="Monitor/index.php"> 
            <h3>Monitor</h3>
            <?php     
                $sql_count = "SELECT COUNT(*) AS total_monitor FROM equipamento WHERE categoria = 'monitor' AND status = 'ativo'";
                $result_count = mysqli_query($conexao, $sql_count);
                if ($result_count) {
                    $row_count = mysqli_fetch_assoc($result_count);
    ...
    <div class="card"> 
        <a href="MonitorTouch/index.php"> 
            <h3>Monitor Touch</h3>
            <?php     
                $sql_count = "SELECT COUNT(*) AS total_monitortouch FROM equipamento WHERE categoria = 'Monitor Touch' AND status = 'ativo'";
                $result_count = mysqli_query($conexao, $sql_count);
                if ($result_count) {
                    $row_count = mysqli_fetch_assoc($result_count);
    ...
    <div class="card"> 
        <a href="Mouse/index.php"> 
            <h3>Mouse</h3>
            <?php     
                $sql_count = "SELECT COUNT(*) AS total_mouse FROM equipamento WHERE categoria = 'mouse' AND status = 'ativo'";
                $result_count = mysqli_query($conexao, $sql_count);
                if ($result_count) {
                    $row_count = mysqli_fetch_assoc($result_count);
    ...
    <div class="card"> 
        <a href="Nobreak/index.php"> 
            <h3>Nobreak</h3>
            <?php     
                $sql_count = "SELECT COUNT(*) AS total_nobreak FROM equipamento WHERE categoria = 'nobreak' AND status = 'ativo'";
                $result_count = mysqli_query($conexao, $sql_count);
                if ($result_count) {
                    $row_count = mysqli_fetch_assoc($result_count);
    ...
    <div class="card"> 
        <a href="Notebook/index.php"> 
            <h3>Notebook</h3>
            <?php     
                $sql_count = "SELECT COUNT(*) AS total_notebook FROM equipamento WHERE categoria = 'notebook' AND status = 'ativo' ";
                $result_count = mysqli_query($conexao, $sql_count);
                if ($result_count) {
                    $row_count = mysqli_fetch_assoc($result_count);
    ...
    <div class="card"> 
        <a href="Raspbarry/index.php"> 
            <h3>RaspBerry</h3>
            <?php     
                $sql_count = "SELECT COUNT(*) AS total_raspbarry FROM equipamento WHERE categoria = 'Raspberry' AND status = 'ativo'";
                $result_count = mysqli_query($conexao, $sql_count);
                if ($result_count) {
                    $row_count = mysqli_fetch_assoc($result_count);
    ...
    <div class="card"> 
        <a href="RelogioDePonto/index.php"> 
            ...
            <?php 
                $sql_count = "SELECT COUNT(*) AS total_relogioP FROM equipamento WHERE categoria = 'Relogio De Ponto' AND status = 'ativo'";
                $result_count = mysqli_query($conexao, $sql_count);
                if ($result_count) {
                    $row_count = mysqli_fetch_assoc($result_count);
    ...
    <div class="card"> 
        <a href="RB/indexrb.php"> 
            <h3>Router Board</h3>
            <?php     
                $sql_count = "SELECT COUNT(*) AS total_rb FROM equipamento WHERE categoria = 'Router Board' AND status = 'ativo' ";
                $result_count = mysqli_query($conexao, $sql_count);
                if ($result_count) {
                    $row_count = mysqli_fetch_assoc($result_count);
    ...
    <div class="card"> 
        <a href="SSD/index.php"> 
            <h3>SSD</h3>
            <?php     
                $sql_count = "SELECT COUNT(*) AS total_ssd FROM equipamento WHERE categoria = 'ssd' AND status = 'ativo'";
                $result_count = mysqli_query($conexao, $sql_count);
                if ($result_count) {
                    $row_count = mysqli_fetch_assoc($result_count);
    ...
    <div class="card"> 
        <a href="Switch/index.php"> 
            <h3> Switch </h3>
            <?php 
                $sql_count = "SELECT COUNT(*) AS total_switch FROM equipamento WHERE categoria = 'Switch' AND status = 'ativo'";
                $result_count = mysqli_query($conexao, $sql_count);
                if ($result_count) {
                    $row_count = mysqli_fetch_assoc($result_count);
    ...
    <div class="card"> 
        <a href="Teclado/index.php"> 
            <h3>Teclado</h3>
            <?php     
                $sql_count = "SELECT COUNT(*) AS total_teclado FROM equipamento WHERE categoria = 'teclado' AND status = 'ativo'";
                $result_count = mysqli_query($conexao, $sql_count);
                if ($result_count) {
                    $row_count = mysqli_fetch_assoc($result_count);
    ...
    <div class="card"> 
        <a href="Transformador/index.php"> 
            <h3>Transformador</h3>
            <?php     
                $sql_count = "SELECT COUNT(*) AS total_transformador FROM equipamento WHERE categoria = 'transformador' AND status = 'ativo'";
                $result_count = mysqli_query($conexao, $sql_count);
                if ($result_count) {
                    $row_count = mysqli_fetch_assoc($result_count);
    ...
    <div class="card"> 
        <a href="UniFi/index.php"> 
            <h3>UniFi</h3>
            <?php     
                $sql_count = "SELECT COUNT(*) AS total_unifi FROM equipamento WHERE categoria = 'unifi' AND status = 'ativo'";
                $result_count = mysqli_query($conexao, $sql_count);
                if ($result_count) {
                    $row_count = mysqli_fetch_assoc($result_count);
    ...
    <div class="card"> 
        <a href="VivoBox/index.php"> 
            <h3>VivoBox</h3>
            <?php     
                $sql_count = "SELECT COUNT(*) AS total_vivobox FROM equipamento WHERE categoria = 'vivobox' AND status = 'ativo'";
                $result_count = mysqli_query($conexao, $sql_count);
                if ($result_count) {
                    $row_count = mysqli_fetch_assoc($result_count);
    ...
    <div class="card"> 
        <a href="WebCam/index.php"> 
            <h3>Webcam</h3>
            <?php     
                $sql_count = "SELECT COUNT(*) AS total_webcam FROM equipamento WHERE categoria = 'webcam' AND status = 'ativo'";
                $result_count = mysqli_query($conexao, $sql_count);
                if ($result_count) {
                    $row_count = mysqli_fetch_assoc($result_count);
