...
<body>
    ...
    <?php
        ...
        if(!empty($_GET['pesquisa'])){
            ...
            $pesq = $_GET['pesquisa'];
            $sql = "SELECT * FROM equipamento WHERE categoria = 'relogioP' AND status = 'inativo' AND
            (marca LIKE '%$pesq%' or modelo LIKE'%$pesq%' or serial LIKE '%$pesq%' or data_entrada LIKE'%$pesq%' or patrimonio LIKE '%$pesq%')";

            $sql_count = "SELECT COUNT(*) AS total_relogioP FROM equipamento WHERE categoria = 'relogioP' AND status = 'inativo' AND
            (marca LIKE '%$pesq%' or modelo LIKE'%$pesq%' or serial LIKE '%$pesq%' or data_entrada LIKE'%$pesq%' or patrimonio LIKE '%$pesq%')";
            ...
            $sql = "SELECT * FROM equipamento WHERE categoria = 'relogioP' AND status = 'inativo'";

            $sql_count = "SELECT COUNT(*) AS total_relogioP FROM equipamento WHERE categoria = 'relogioP' AND status = 'inativo'";
            $result_count = mysqli_query($conexao, $sql_count);
