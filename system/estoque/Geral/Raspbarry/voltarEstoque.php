...
if (isset($_GET["id"])) {
    ...
    $sql_select = "SELECT * FROM equipamento WHERE id_equip = ? AND categoria = 'raspbarry'";
...
<head>
    ...
    <title>Raspbarry</title>
</head>
<body>

    <h2 style="text-align: center;">Voltar o Raspbarry para o estoque</h2>
