...
if (isset($_GET["id"])) {
    ...
    $sql_select = "SELECT * FROM equipamento WHERE id_equip = ? AND categoria = 'transformador'";
...
<head>
    ...
    <title>transformador</title>
</head>
<body>

    <h2 style="text-align: center;">Dar saida - transformador</h2>
