...
<body>
    ...
    <?php
        ...
        $sql_count = "SELECT COUNT(*) AS total_ssd FROM equipamento WHERE categoria = 'ssd' AND status = ?";
        ...
        $sql = "SELECT * FROM equipamento WHERE status = ? AND categoria = 'ssd' AND status = 'inativo'";
