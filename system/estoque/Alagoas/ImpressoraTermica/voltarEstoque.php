...
if (isset($_GET["id"])) {
    ...
    $sql_select = "SELECT * FROM equipamento WHERE id_equip = ? AND categoria = 'Impressora Térmica'";
...
<head>
    ...
    <title>Impressora Termica</title>
</head>
<body>

    <h2 style="text-align: center;">Voltar o Impressora Termica para o estoque</h2>
