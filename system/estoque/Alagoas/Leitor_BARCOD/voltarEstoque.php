...
if (isset($_GET["id"])) {
    ...
    $sql_select = "SELECT * FROM equipamento WHERE id_equip = ? AND categoria = 'leitor de barra'";
...
<head>
    ...
    <title>Leitora de Barra</title>
</head>
<body>

    <h2 style="text-align: center;">Voltar o Leitor de Barra para o estoque</h2>
