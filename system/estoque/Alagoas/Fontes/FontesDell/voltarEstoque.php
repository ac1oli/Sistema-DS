...
if (isset($_GET["id"])) {
    ...
    $sql_select = "SELECT * FROM equipamento WHERE id_equip = ? AND categoria = 'Fonte DELL'";
...
<head>
    ...
    <title>Fonte DELL</title>
</head>
<body>

    <h2 style="text-align: center;">Voltar o Fonte DELL para o estoque</h2>
