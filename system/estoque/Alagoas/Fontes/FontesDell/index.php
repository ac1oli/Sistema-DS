...
<body>
    ...
    <?php
        ...
        if(!empty($_GET['pesquisa'])){
            ...
            $pesq = $_GET['pesquisa'];
            $sql = "SELECT * FROM equipamento WHERE categoria = 'Fonte DELL' AND status = 'ativo'AND local = 'AL' AND
            (marca LIKE '%$pesq%' or modelo LIKE'%$pesq%' or serial LIKE '%$pesq%' or data_entrada LIKE'%$pesq%' or patrimonio LIKE '%$pesq%')";

            $sql_count = "SELECT COUNT(*) AS total_fonteDell FROM equipamento WHERE categoria = 'Fonte DELL' AND status = 'ativo' AND local = 'AL' AND
            (marca LIKE '%$pesq%' or modelo LIKE'%$pesq%' or serial LIKE '%$pesq%' or data_entrada LIKE'%$pesq%' or patrimonio LIKE '%$pesq%')";
            ...
            $sql = "SELECT * FROM equipamento WHERE categoria = 'Fonte DELL' AND status = 'ativo' AND local = 'AL'";

            $sql_count = "SELECT COUNT(*) AS total_fonteDell FROM equipamento WHERE categoria = 'Fonte DELL' AND status = 'ativo' AND local = 'AL'";
            $result_count = mysqli_query($conexao, $sql_count);
