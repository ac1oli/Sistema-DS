...
if (isset($_GET["id"])) {
    ...
    $sql_select = "SELECT * FROM equipamento WHERE id_equip = ? AND categoria = 'Relogio De Ponto'";
...
<body>
    ...
    <h2 style="text-align: center;">Voltar o Relogio de Ponto para o estoque</h2>
