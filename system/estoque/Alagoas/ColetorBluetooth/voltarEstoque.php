...
if (isset($_GET["id"])) {
    ...
    $sql_select = "SELECT * FROM equipamento WHERE id_equip = ? AND categoria = 'Coletor Bluetooth'";
...
<head>
    ...
    <title>Coletor Bluetooth</title>
</head>
<body>

    <h2 style="text-align: center;">Voltar o Coletor Bluetooth para o estoque</h2>
