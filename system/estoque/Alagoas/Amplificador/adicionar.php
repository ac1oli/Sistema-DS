...
include "../../../../config/funcoes_validacao.php"; // Inclui o arquivo de funções de validação e validação
?>
...
<body class="adicionar">
    ...
    <form action="salvar.php" method="POST">
        ...
        <!-- Importante: categoria 'Amplificador' -->
        <input type="hidden" name="categoria" value="amplificador">
