...
if (isset($_GET["id"])) {
    ...
    $sql_select = "SELECT * FROM equipamento WHERE id_equip = ? AND categoria = 'Monitor Touch'";
...
<body>
    ...
    <h2 style="text-align: center;">Voltar o  <strong> Monitor Touch</strong> para o estoque</h2>
