...
<body>
    ...
    <?php
        ...
        if(!empty($_GET['pesquisa'])){
            ...
            $sql_count = "SELECT COUNT(*) AS total_Raspberry FROM equipamento WHERE categoria = 'Raspberry' AND status = 'ativo' AND local = 'RJ-Centro' AND
            (marca LIKE '%$pesq%' or modelo LIKE'%$pesq%' or serial LIKE '%$pesq%' or data_entrada LIKE'%$pesq%' or patrimonio LIKE '%$pesq%')";
            ...
            $sql_count = "SELECT COUNT(*) AS total_Raspberry FROM equipamento WHERE categoria = 'Raspberry' AND status = 'ativo' AND local = 'RJ-Centro'";
            $result_count = mysqli_query($conexao, $sql_count);
