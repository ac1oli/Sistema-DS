...
if (isset($_GET["id"])) {
    ...
    $sql_select = "SELECT * FROM equipamento WHERE id_equip = ? AND categoria = 'Router Board'";
...
<body>
    ...
    <h2 style="text-align: center;">Voltar o  <strong> Router Board </strong> para o estoque</h2>
