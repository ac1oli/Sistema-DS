...
if (isset($_GET["id"])) {
    ...
    $sql_select = "SELECT * FROM equipamento WHERE id_equip = ? AND categoria = 'Coletor Touch'";
...
<head>
    ...
    <title>Coletor Touch</title>
</head>
<body>

    <h2 style="text-align: center;">Voltar o Coletor Touch para o estoque</h2>
