...
if (isset($_GET["id"])) {
    ...
    $sql_select = "SELECT * FROM equipamento WHERE id_equip = ? AND categoria = 'celular'";
...
<head>
    ...
    <title>Editar Leito de Barra</title>
</head>
<body>

    <h2 style="text-align: center;">Voltar o Celular para o estoque</h2>
