...
<body class="adicionar">
    ...
    <form action="salvar.php" method="POST">
        ...
        <label for="armazenamento">ARMAENAMENTO</label>
        <input type="text" name="armazenamento" id="armazenamento" placeholder="armazenamento" >

        <label for="obs">OBSERVAÇÃO</label>
        <input type="text" name="obs" id="obs" placeholder="Observação" >

        <label for="sistema_operacional">SO</label>
        <input type="text" name="sistema_operacional" id="sistema_operacional" placeholder="Sistema Operacional" >

        <label for="data_entrada">DATA DE ENTRADA</label>
        <input type="date" name="data_entrada" id="data_entrada" required>

        <!-- Importante: categoria 'HD' -->
        <input type="hidden" name="categoria" value="hd">
