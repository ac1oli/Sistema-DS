...
<body>
    ...
    <h3>
        ...
        <a href="adicionar.php">Adicionar Celular</a>
    ...
    <?php
        ...
        if(!empty($_GET['pesquisa'])){
            ...
            $pesq = $_GET['pesquisa'];
            $sql = "SELECT * FROM equipamento WHERE categoria = 'celular' AND status = 'ativo' AND local = 'RJ-CD-Queimado' AND
            (marca LIKE '%$pesq%' or modelo LIKE'%$pesq%' or serial LIKE '%$pesq%' or data_entrada LIKE'%$pesq%' or patrimonio LIKE '%$pesq%' or imei_equip LIKE '%$pesq%')";

            $sql_count = "SELECT COUNT(*) AS total_celular FROM equipamento WHERE categoria = 'celular' AND status = 'ativo' AND local = 'RJ-CD-Queimado' AND
            (marca LIKE '%$pesq%' or modelo LIKE'%$pesq%' or serial LIKE '%$pesq%' or data_entrada LIKE'%$pesq%' or patrimonio LIKE '%$pesq%' or imei_equip LIKE '%$pesq%')";
            ...
            $sql = "SELECT * FROM equipamento WHERE categoria = 'celular' AND status = 'ativo' AND local = 'PE'";
    ...
    <table border="1px solid black">
        ...
        <?php while ($row = mysqli_fetch_assoc($result)) : ?>
            <tr>
                ...
                <td>
                    <a href="dar_baixa.php?id=<?= urlencode($row['id_equip']) ?>">Dar Saída</a>
                </td>
            </tr>
        <?php endwhile; ?>
    </table>
