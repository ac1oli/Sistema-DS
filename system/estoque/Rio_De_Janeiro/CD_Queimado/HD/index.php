...
<body>
    ...
    <h3>
        ...
        <a href="adicionar.php">Adicionar HD</a>
    ...
    <?php
        ...
        if(!empty($_GET['pesquisa'])){
            ...
            $pesq = $_GET['pesquisa'];
            $sql = "SELECT * FROM equipamento WHERE categoria = 'HD' AND status = 'ativo' AND local = 'RJ-CD-Queimado' AND
            ...
            $sql_count = "SELECT COUNT(*) AS total_hd FROM equipamento WHERE categoria = 'HD' AND status = 'ativo' AND local = 'RJ-CD-Queimado' AND
            ...
            $sql = "SELECT * FROM equipamento WHERE categoria = 'HD' AND status = 'ativo' AND local = 'RJ-CD-Queimado'";
