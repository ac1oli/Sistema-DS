...
<head>
    ...
    <title>ESTOQUE - Teclado</title>
</head>
<body>

    <nav>
        <h1>ESTOQUE - Teclado</h1>
    ...
    <h3>
        ...
        <a href="adicionar.php">Adicionar Teclado</a>
    ...
    <?php
        ...
        // Buscar apenas os equipamentos da categoria 'Teclado'
        if(!empty($_GET['pesquisa'])){

            $pesq = $_GET['pesquisa'];
            $sql = "SELECT * FROM equipamento WHERE categoria = 'teclado' AND status = 'ativo' AND local = 'RJ-CD-Queimado' AND
            (marca LIKE '%$pesq%' or modelo LIKE'%$pesq%' or serial LIKE '%$pesq%' or data_entrada LIKE'%$pesq%')";

            $sql_count = "SELECT COUNT(*) AS total_teclado FROM equipamento WHERE categoria = 'teclado' AND status = 'ativo' AND local = 'RJ-CD-Queimado' AND
            (marca LIKE '%$pesq%' or modelo LIKE'%$pesq%' or serial LIKE '%$pesq%' or data_entrada LIKE'%$pesq%')";
            ...
            if ($result_count) {
                ...
                echo "<h3> Total de Teclado:  $total_teclado </h3>";
            }

        }else{
            $sql = "SELECT * FROM equipamento WHERE categoria = 'teclado' AND status = 'ativo' AND local = 'RJ-CD-Queimado'";
