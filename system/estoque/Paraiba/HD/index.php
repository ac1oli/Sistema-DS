...
<body>
    ...
    <?php
        ...
        if(!empty($_GET['pesquisa'])){
            ...
            $pesq = $_GET['pesquisa'];
            $sql = "SELECT * FROM equipamento WHERE categoria = 'HD' AND status = 'ativo' AND local = 'PB' AND
            ...
            $sql_count = "SELECT COUNT(*) AS total_hd FROM equipamento WHERE categoria = 'HD' AND status = 'ativo' AND local = 'PB' AND
            ...
            $sql = "SELECT * FROM equipamento WHERE categoria = 'HD' AND status = 'ativo' AND local = 'PB'";
