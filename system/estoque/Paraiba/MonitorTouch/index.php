...
<body>
    ...
    // Buscar apenas os equipamentos da categoria 'monitortouch'
        if(!empty($_GET['pesquisa'])){
            ...
            $pesq = $_GET['pesquisa'];
            $sql = "SELECT * FROM equipamento WHERE categoria = 'Monitor Touch' AND status = 'ativo' AND local = 'PB' AND
            (marca LIKE '%$pesq%' or modelo LIKE'%$pesq%' or serial LIKE '%$pesq%' or data_entrada LIKE'%$pesq%')";

            $sql_count = "SELECT COUNT(*) AS total_monitortouch FROM equipamento WHERE categoria = 'Monitor Touch' AND status = 'ativo' AND local = 'PB' AND
            ...
            $sql = "SELECT * FROM equipamento WHERE categoria = 'Monitor Touch' AND status = 'ativo' AND local = 'PB'";
