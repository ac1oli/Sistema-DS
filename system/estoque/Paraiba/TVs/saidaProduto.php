...
<body>
    ...
    <?php
        ...
        if(!empty($_GET['pesquisa'])){
            ...
            $pesq = $_GET['pesquisa'];
            $sql = "SELECT * FROM equipamento WHERE categoria = 'tvs' AND status = 'inativo' AND local = 'PB' AND
            (marca LIKE '%$pesq%' or modelo LIKE'%$pesq%' or serial LIKE '%$pesq%' or data_entrada LIKE'%$pesq%')";

            $sql_count = "SELECT COUNT(*) AS total_tvs FROM equipamento WHERE categoria = 'tvs' AND status = 'inativo' AND local = 'PB' AND
            (marca LIKE '%$pesq%' or modelo LIKE'%$pesq%' or serial LIKE '%$pesq%' or data_entrada LIKE'%$pesq%')";
            ...
            $sql = "SELECT * FROM equipamento WHERE categoria = 'tvs' AND status = 'inativo' AND local = 'PB'";

            $sql_count = "SELECT COUNT(*) AS total_tvs FROM equipamento WHERE categoria = 'tvs' AND status = 'inativo' AND local = 'PB'";
            $result_count = mysqli_query($conexao, $sql_count);
