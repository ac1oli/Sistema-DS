...
if (isset($_GET["id"])) {
    ...
    $sql_select = "SELECT * FROM equipamento WHERE id_equip = ? AND categoria = 'Fonte REP'";
...
<head>
    ...
    <title>Fonte REP</title>
</head>
<body>

    <h2 style="text-align: center;">Voltar o Fonte REP para o estoque</h2>
