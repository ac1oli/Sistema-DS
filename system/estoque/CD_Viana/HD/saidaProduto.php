...
<body>
    ...
    <?php
        ...
        if(!empty($_GET['pesquisa'])){
            ...
            $pesq = $_GET['pesquisa'];
            $sql = "SELECT * FROM equipamento WHERE categoria = 'HD' AND status = 'inativo' AND local = 'CD-Viana' AND
            ...
            $sql_count = "SELECT COUNT(*) AS total_hd FROM equipamento WHERE categoria = 'HD' AND status = 'inativo' AND local = 'CD-Viana' AND
            ...
            $sql = "SELECT * FROM equipamento WHERE categoria = 'HD' AND status = 'inativo' AND local = 'CD-Viana'";

            $sql_count = "SELECT COUNT(*) AS total_hd FROM equipamento WHERE categoria = 'HD' AND status = 'inativo' AND local = 'CD-Viana'";
            $result_count = mysqli_query($conexao, $sql_count);
