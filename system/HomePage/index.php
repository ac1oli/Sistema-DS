...
<div id="navCont">
    ...
    <main>
            ...
            <div class="card"> 
                <a href="../estoque/index.php"> 
                    <strong style="font-size: 18px;">Estoque</strong>
                </a>
            </div>

            <div class="card"> 
                <a href="../Lojas/index.php"> 
                    <strong style="font-size: 18px;">Lojas</strong>
                </a>
            </div>

            <div class="card"> 
                <a href="../Inventario/index.php"> 
                    <strong style="font-size: 18px; text-align: center;">Inventário</strong>
                </a>
            </div>
    </main>
